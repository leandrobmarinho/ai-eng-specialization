...
def preprocess(text: str) -> list[str]:
    ...
    pt_stop = set(nltk.corpus.stopwords.words("portuguese")) - {"e", "ou", "não"}
...
def boolean_search(query, index):
    ...
    parser_query = parser.parse(query)
    parser_query

    with index.searcher() as searcher:
        results = searcher.search(parser_query)
